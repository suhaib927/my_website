...
<div class = "masthead-subheading font-weight-light mb-0" style="margin: 50px 350px;text-align:left">
    ...
    <footer class="footer text-center" style="margin-top: 200px;">
        <div class="container">
            <div class="row">
                <!-- Footer Location-->
                <div class="col-lg-4 mb-5 mb-lg-0" style="margin-top: 40px;">
                    Copyright © Eng.Suhayb alhac osman 2023
                </div>
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <h4 class="text-uppercase mb-4">Sosyal medİa</h4>
                    <a class="btn btn-outline-light btn-social mx-1" href="https://www.instagram.com/suhaib_.24/"
                    ...
                    <a class="btn btn-outline-light btn-social mx-1" href="https://twitter.com/suhayb_osmann"
                        target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                    ...
                    <a class="btn btn-outline-light btn-social mx-1" href="https://github.com/suhaib927"
                        target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                ...
                <!-- Footer About Text-->
                <div class="col-lg-4">
                    <p class="lead mb-0" style="margin-top: 20px;">
